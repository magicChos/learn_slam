...
#ifndef __geometry_messages_Transform_hpp__
#define __geometry_messages_Transform_hpp__
...
{
    public:
        geometry_messages::Vector3 translation;

        geometry_messages::Quaternion rotation;
