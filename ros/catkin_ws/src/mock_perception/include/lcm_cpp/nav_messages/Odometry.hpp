...
#ifndef __nav_messages_Odometry_hpp__
#define __nav_messages_Odometry_hpp__
...
#include "geometry_messages/Twist.hpp"
...
class Odometry
{
    public:
        ...
        geometry_messages::Pose pose;

        geometry_messages::Twist twist;
...
uint64_t Odometry::_computeHash(const __lcm_hash_ptr *p)
{
    ...
    uint64_t hash = 0x97f82279756d9d18LL +
         ...
         geometry_messages::Twist::_computeHash(&cp);
