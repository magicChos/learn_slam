...
public:
    ...
    randomized_minimum_bounding_ball(InputIterator begin, InputIterator end, circle<T>& circle)
    {
                                ...
                                circle<T>& circle)
    {
        ...
        for (InputIterator it1 = begin; it1 != end; ++it1)
        {
            for (InputIterator it2 = it1 + 1; it2 != end; ++it2)
            {
                ...
                {
                    cg::circle<T> current_circle = make_circle((*it1),(*it2),(*it3));
