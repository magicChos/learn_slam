...
namespace cg {
   ...
   inline bool intersect(const segment<T,2>& segment, const quadratic_bezier<T,2>& bezier, const std::size_t& steps)
   {
      return simplex_to_bezier_intersect
             <T,2,cg::segment<T,2>,quadratic_bezier<T,2> >
   ...
   {
      return simplex_to_bezier_intersect
             <T,2,cg::segment<T,2>,cubic_bezier<T,2> >
             (segment, bezier, steps);
   }
   ...
   {
      return simplex_to_bezier_intersect<T,3,cg::segment<T,3>,quadratic_bezier<T,3> >
             (segment, bezier, steps);
   }
   ...
   {
      return simplex_to_bezier_intersect
             <T,3,cg::segment<T,3>,cubic_bezier<T,3> >
             (segment, bezier, steps);
   }
   ...
   {
      return simplex_to_bezier_intersect
             <T,2,cg::line<T,2>,quadratic_bezier<T,2> >
             (line, bezier, steps);
   }
   ...
   {
      return simplex_to_bezier_intersect
             <T,2,cg::line<T,2>,cubic_bezier<T,2> >
             (line, bezier, steps);
   }
   ...
   {
      return simplex_to_bezier_intersect
             <T,3,cg::line<T,3>,quadratic_bezier<T,3> >
             (line, bezier, steps);
   }
   ...
   {
      return simplex_to_bezier_intersect
             <T,3,cg::line<T,3>,cubic_bezier<T,3> >
             (line, bezier, steps);
   }
   ...
   {
      return simplex_to_bezier_intersect
             <T,2,cg::triangle<T,2>,quadratic_bezier<T,2> >
   ...
   {
      return simplex_to_bezier_intersect<T,2,cg::triangle<T,2>,cubic_bezier<T,2> >(triangle,bezier,steps);
   }
   ...
   {
      return simplex_to_bezier_intersect
             <T,2,cg::rectangle<T>,quadratic_bezier<T,2> >
   ...
   {
      return simplex_to_bezier_intersect
             <T,2,cg::rectangle<T>,cubic_bezier<T,2> >
             (rectangle, bezier, steps);
   }
   ...
   {
      return simplex_to_bezier_intersect
             <T,2,cg::quadix<T,2>,quadratic_bezier<T,2> >
             (quadix, bezier, steps);
   }
   ...
   {
      return simplex_to_bezier_intersect
             <T,2,cg::quadix<T,2>,cubic_bezier<T,2> >
             (quadix, bezier, steps);
   }
   ...
   {
      return simplex_to_bezier_intersect<T,2,cg::circle<T>,quadratic_bezier<T,2> >(circle,bezier,steps);
   }

   template <typename T>
   inline bool intersect(const circle<T>& circle, const cubic_bezier<T,2>& bezier, const std::size_t& steps)
   {
      return simplex_to_bezier_intersect<T,2,cg::circle<T>,cubic_bezier<T,2> >(circle,bezier,steps);
   }
   ...
   {
      return simplex_to_bezier_intersect<T,3,cg::sphere<T>,quadratic_bezier<T,3> >(sphere,bezier,steps);
   }

   template <typename T>
   inline bool intersect(const sphere<T>& sphere, const cubic_bezier<T,3>& bezier, const std::size_t& steps)
   {
      return simplex_to_bezier_intersect<T,3,cg::sphere<T>,cubic_bezier<T,3> >(sphere,bezier,steps);
   }
                                  ...
                                  const std::size_t& steps)
   {
      ...
      <T, 2, cg::segment<T,2>, quadratic_bezier<T,2>, OutputIterator>
      (
        segment,
        bezier,
        out,
   ...
   {
      simplex_to_bezier_intersection_point
      <T,2,cg::segment<T,2>,cubic_bezier<T,2>,OutputIterator>
      (
        segment,
        bezier,
        out,
   ...
   {
      simplex_to_bezier_intersection_point
      <T,3,cg::segment<T,3>,quadratic_bezier<T,3>,OutputIterator>
      (
        segment,
        bezier,
        out,
   ...
   {
      simplex_to_bezier_intersection_point
      <T,3,cg::segment<T,3>,cubic_bezier<T,3>,OutputIterator>
      (
        segment,
        bezier,
        out,
                                           ...
                                           const std::size_t& steps)
   {
      ...
      for (std::size_t i = 1; i < steps; ++i)
      {
         ...
         cg::segment<T,Dimension> segment = make_segment(previous_point,current_point);
   ...
   {
      cg::segment<T,2> tmp_segment = translate(-circle.x, -circle.y, segment);

      const T rsqr  = cg::sqr(circle.radius);
      const T drsqr = lay_distance(tmp_segment);
      const T dsqr  = cg::sqr(tmp_segment[0].x * tmp_segment[1].y - tmp_segment[1].x * tmp_segment[0].y);
   ...
   inline triangle<T,2> create_morley_triangle(const triangle<T,2>& triangle)
   {
      ...
      const cg::triangle<T,2> triangle1 = create_triangle(edge(tri, 0), angle1, angle2);
      const cg::triangle<T,2> triangle2 = create_triangle(edge(tri, 1), angle2, angle3);
      const cg::triangle<T,2> triangle3 = create_triangle(edge(tri, 2), angle3, angle1);
   ...
   inline triangle<T,2> create_anticevian_triangle(const triangle<T,2>& triangle, const point2d<T>& point)
   {
      ...
      {
         typedef const cg::line<T,2> line2d_t;

         line2d_t opp_edge    = cg::make_line(opposing_edge(triangle,i));
         line2d_t cevian_edge = cg::make_line(triangle[i],point);
         line2d_t orthic_edge = cg::make_line
                                        (
                                          triangle[i],
                                          cg::closest_point_on_line_from_point(opp_edge,triangle[i])
                                        );

         //if (!robust_collinear(orthic_edge,point))
         {
            point_list[i] = cg::intersection_point(cevian_edge, make_line(orthic_edge[i], cg::mirror(point,opp_edge)));
         }
         //else
   ...
   {
      const point2d<T> p = make_point(cg::inscribed_circle(triangle));
   ...
   {
      cg::triangle<T,2> triangle_ = create_excentral_triangle(triangle);
   ...
   {
      cg::triangle<T,3> triangle_ = create_excentral_triangle(triangle);
   ...
   inline triangle<T,2> create_circumcevian_triangle(const triangle<T,2>& triangle, const point2d<T>& point)
   {
      ...
      cg::triangle<T,2> triangle_ = degenerate_triangle2d<T>();
   ...
   template <typename T> inline void create_right_triangle(const cg::point2d<T>& p1, const cg::point2d<T>& p2,
                                                                 cg::point2d<T>& c1,       cg::point2d<T>& c2)
   {
      const T distance = cg::distance(p1,p2);

      const cg::point2d <T> mid = cg::segment_mid_point(p1,p2);
      const cg::vector2d<T>   v = cg::normalize(cg::perpendicular(p1 - p2)) * (distance / T(2.0));
                                             ...
                                             std::vector<line<T,2> >& lines)
   {
      ...
      else
      {
         ...
         cg::circle_tangent_points(circle0, i, c0pnt0, c0pnt1);
         cg::circle_tangent_points(circle1, i, c1pnt0, c1pnt1);
                                          ...
                                          std::vector< line<T,2> >& lines)
   {
      ...
      else
      {
         ...
         cg::circle_tangent_points(circle0, p, c0pnt0, c0pnt1);
         cg::circle_tangent_points(circle1, p, c1pnt0, c1pnt1);
                                                        ...
                                                        const std::size_t& steps)
   {
      ...
      cg::generate_bezier(bezier,std::back_inserter(point_list),steps);
   ...
   template <typename T>
   inline bool is_right_triangle(const cg::triangle<T,2>& triangle)
   {
      const T a = cg::lay_distance(cg::edge(triangle,0));
      const T b = cg::lay_distance(cg::edge(triangle,1));
      const T c = cg::lay_distance(cg::edge(triangle,2));

      return cg::is_equal(a + b,c) || cg::is_equal(a + c,b) || cg::is_equal(b + c,a);
   }

   template <typename T>
   inline bool is_right_triangle(const cg::triangle<T,3>& triangle)
   {
      const T a = cg::lay_distance(cg::edge(triangle,0));
      const T b = cg::lay_distance(cg::edge(triangle,1));
      const T c = cg::lay_distance(cg::edge(triangle,2));
   ...
   {
      cg::segment<T,2> segment_;

      for (std::size_t i = 0; i < cg::segment<T,2>::PointCount; ++i)
      {
   ...
   template <typename T>
   inline line<T,2> mirror(const line<T,2>& line, const cg::line<T,2>& mirror_axis)
   {
      cg::line<T,2> line_;

      for (std::size_t i = 0; i < cg::line<T,2>::PointCount; ++i)
      {
   ...
   {
      cg::rectangle<T> rectangle_;

      for (std::size_t i = 0; i < cg::rectangle<T>::PointCount; ++i)
      {
   ...
   {
      cg::triangle<T,2> triangle_;

      for (std::size_t i = 0; i < cg::triangle<T,2>::PointCount; ++i)
      {
   ...
   {
      cg::quadix<T,2> quadix_;

      for (std::size_t i = 0; i < cg::quadix<T,2>::PointCount; ++i)
      {
   ...
   {
      cg::segment<T,3> segment_;

      for (std::size_t i = 0; i < cg::segment<T,3>::PointCount; ++i)
      {
         segment_[i] = mirror(segment[i],mirror_axis);
      }
   ...
   template <typename T>
   inline line<T,3> mirror(const line<T,3>& line, const cg::line<T,3>& mirror_axis)
   {
      cg::line<T,3> line_;

      for (std::size_t i = 0; i < cg::line<T,3>::PointCount; ++i)
      {
         line_[i] = mirror(line[i],mirror_axis);
      }
   ...
   inline box<T,3> mirror(const box<T,3>& box, const line<T,3>& mirror_axis)
   {
      ...
      for (std::size_t i = 0; i < cg::box<T,3>::PointCount; ++i)
      {
   ...
   {
      cg::triangle<T,3> triangle_;

      for (std::size_t i = 0; i < cg::triangle<T,3>::PointCount; ++i)
      {
         triangle_[i] = mirror(triangle[i],mirror_axis);
      }
   ...
   {
      cg::quadix<T,3> quadix_;

      for (std::size_t i = 0; i < cg::quadix<T,3>::PointCount; ++i)
      {
         quadix_[i] = mirror(quadix[i],mirror_axis);
      }
   ...
   inline polygon<T,2> minkowski_sum(const triangle<T,2>& triangle1, const triangle<T,2>& triangle2)
   {
      ...
      for (std::size_t i = 0; i < cg::triangle<T,2>::PointCount; ++i)
      {
         for (std::size_t j = 0; j < cg::triangle<T,2>::PointCount; ++j)
         {
   ...
   inline polygon<T,2> minkowski_sum(const quadix<T,2>& quadix1, const quadix<T,2>& quadix2)
   {
      ...
      for (std::size_t i = 0; i < cg::quadix<T,2>::PointCount; ++i)
      {
         for (std::size_t j = 0; j < cg::quadix<T,2>::PointCount; ++j)
         {
   ...
   {
      cg::polygon<T,2> polygon;
      cg::polygon<T,2> circle_polygon = make_polygon(circle);
   ...
   {
      cg::point2d<T> point_ = closest_point_on_line_from_point(axis,point);
   ...
   {
      cg::point3d<T> point_ = closest_point_on_line_from_point(axis,point);
      return make_segment(point_,point_);
   }
   ...
   {
      cg::segment<T,2> segment_ = segment;
   ...
   {
      cg::segment<T,3> segment_ = segment;
   ...
   inline rectangle<T> aabb(const triangle<T,2>& triangle)
   {
      ...
      for (std::size_t i = 1; i < cg::triangle<T,2>::PointCount; ++i)
      {
   ...
   inline rectangle<T> aabb(const quadix<T,2>& quadix)
   {
      ...
      for (std::size_t i = 1; i < cg::quadix<T,2>::PointCount; ++i)
      {
   ...
   {
      cg::rectangle<T> rectangle_ = aabb(triangle);
   ...
   {
      cg::rectangle<T> rectangle_ = aabb(rectangle);
   ...
   {
      cg::rectangle<T> rectangle_ = aabb(quadix);
   ...
   {
      cg::rectangle<T> rectangle_ = aabb(circle);
   ...
   inline box<T,3> aabb(const triangle<T,3>& triangle)
   {
      ...
      for (std::size_t i = 1; i < cg::triangle<T,3>::PointCount; ++i)
      {
   ...
   inline box<T,3> aabb(const quadix<T,3>& quadix)
   {
      ...
      for (std::size_t i = 1; i < cg::quadix<T,3>::PointCount; ++i)
      {
   ...
   {
      cg::box<T,3> region = make_box(x1,y1,z1,x2,y2,z2);
   ...
   {
      return cg::scale(scale,scale,point);
   }

   template <typename T>
   inline point3d<T> operator*(const point3d<T>& point, const T& scale)
   {
      return cg::scale(scale,scale,scale,point);
   }
   ...
   inline polygon<T,2> make_polygon(const triangle<T,2>& triangle)
   {
      ...
      polygon_.reserve(cg::triangle<T,2>::PointCount);
   ...
   inline polygon<T,2> make_polygon(const quadix<T,2>& quadix)
   {
      ...
      polygon_.reserve(cg::quadix<T,2>::PointCount);
